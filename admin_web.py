...
<div class="wrap">
  ...
  <div class="tabs">
    ...
    <button type="button" class="tab-btn" data-tab="log" onclick="showTab('log')">실행·공지 이력</button>
  </div>
...
def _render():
    ...
    has_active_search = bool(request.args.get("q", "").strip() or request.args.get("site", "").strip())
